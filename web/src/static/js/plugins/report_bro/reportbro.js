...
var _AddDeleteParameterCmd = __webpack_require__(57);
...
var ReportBro = function () {
    function ReportBro(element, properties) {
        ...
        this.properties = {
            ...
            reportServerUrl: 'http://69.64.74.204:9000/v1/preview-report', // ACA VA EL URL
            reportServerUrlSave: 'http://69.64.74.204:9000/v1/report', // ACA VA EL URL
    ...
    (0, _createClass3.default)(ReportBro, [{
        ...
        key: 'saveDoc',
        value: function saveDoc(idReporte){
            let report = this.getReport();
            $.ajax(this.properties.reportServerUrlSave, {
                data: { data: report, idformato: idReporte},
                type: "PUT", contentType: "application/json",
                timeout: this.properties.reportServerTimeout,
                crossDomain: this.properties.reportServerUrlCrossDomain,
                success: function success(data) {
                    alert('Reporte guardado con éxito!' + data);
                },
                error: function error(jqXHR, textStatus, errorThrown) {
